...
#include <interface_sim/need_publisherConfig.h>

ros::Publisher need_pub;

void callback(need_publisher::need_publisherConfig &config, uint32_t level)
{
...
int main(int argc, char **argv)
{
        ...
        dynamic_reconfigure::Server<need_publisher::need_publisherConfig> server;
        dynamic_reconfigure::Server<need_publisher::need_publisherConfig>::CallbackType f;
        sleep(2);
