       ...
       if flag :
              ...
              if 'u'+msg_list[7]=='u'+'None':
                     ...
                     try:
                            ...
                            print("他人评价 Emotion recognition failed !")
                            eclass='none'
                     # senti=Sentiment()
